...
namespace DoctrineProxies\__CG__\Correction\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CorrectionToken extends \Correction\Entity\CorrectionToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CorrectionToken $proxy) {
