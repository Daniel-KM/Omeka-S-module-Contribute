...
trait TraitSettingsFieldset
{
    protected function appendGlobalAndTemplateCommonSettings(): self
    {
        $this
            ->add([
                ...
                'options' => [
                    ...
                    // The label is different for main settings and templates.
                    // Here, the label is for main settings.
                    'label' => 'Contribution modes for all contributable templates', // @translate
                    'value_options' => [
            ...
            ->add([
                'name' => 'contribute_allow_edit_until',
    ...
    protected function appendMessagesSettings(): self
    {
        $this
            ->add([
            ...
            ->add([
                'name' => 'contribute_message_author_confirmation_subject',
                'type' => Element\Text::class,
                'options' => [
                    'element_group' => 'contribution',
            ...
            ->add([
                'name' => 'contribute_message_author_confirmation_body',
                'type' => Element\Textarea::class,
                'options' => [
                    'element_group' => 'contribution',
            ...
            ->add([
                'name' => 'contribute_message_reviewer_confirmation_subject',
                'type' => Element\Text::class,
                'options' => [
                    'element_group' => 'contribution',
            ...
            ->add([
                'name' => 'contribute_message_reviewer_confirmation_body',
                'type' => Element\Textarea::class,
                'options' => [
                    'element_group' => 'contribution',
